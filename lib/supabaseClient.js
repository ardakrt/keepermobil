...
if (!supabaseUrl || !supabaseAnonKey) {
  console.warn(
    'Supabase credentials are missing. Set EXPO_PUBLIC_SUPABASE_URL and EXPO_PUBLIC_SUPABASE_ANON_KEY (or expo.extra) before using the client.',
  );
}

// Quick diagnostic removed to reduce runtime noise.
